...
{
  Product* temp = new Book(prodName_, price_, qty_, isbn_, author_);
  return temp;
...
{
  Product* temp = new Clothing(prodName_, price_, qty_, size_, brand_);
  return temp;
...
{
  Product* temp = new Movie(prodName_, price_, qty_, genre_, rating_);
  return temp;
